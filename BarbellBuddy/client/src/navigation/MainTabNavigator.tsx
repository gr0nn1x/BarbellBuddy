...
import { MainTabParamList, FriendsStackParamList, LiftsStackParamList, GroupsStackParamList } from './types';
...
const MainTabNavigator = () => {
  return (
    ...
    >
      ...
      <Tab.Screen name="Programs" component={WorkoutPlanningScreen} />
